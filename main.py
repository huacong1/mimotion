...
min_dict = {time_list[0]: 3657, time_list[1]: 8643, time_list[2]: 18656, time_list[3]: 26895, time_list[4]: 35974, time_list[5]: 45267, time_list[6]: 54357}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 7856, time_list[1]: 17658, time_list[2]: 25687, time_list[3]: 35479, time_list[4]: 44587, time_list[5]: 53547, time_list[6]: 68657}
# 设置结束
